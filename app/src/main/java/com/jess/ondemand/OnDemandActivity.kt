...
class OnDemandActivity : BaseSplitActivity(),
    OnDemandDelivery by OnDemandDeliveryImpl() {
    ...
    private fun initView() {
        ...
        findViewById<Button>(R.id.bt_assets).setOnClickListener {
            loadAndLaunchModule(OnDemandModuleName.ASSETS)
        }

        findViewById<Button>(R.id.bt_ekyc).setOnClickListener {
            loadAndLaunchModule(OnDemandModuleName.EKYC)
        }

        findViewById<Button>(R.id.bt_idcard).setOnClickListener {
            loadAndLaunchModule(OnDemandModuleName.IDCARD)
        }

        findViewById<Button>(R.id.bt_all).setOnClickListener {
            loadAndLaunchModule(
                OnDemandModuleName.ASSETS,
                OnDemandModuleName.EKYC,
                OnDemandModuleName.IDCARD
            )
        }
    }
